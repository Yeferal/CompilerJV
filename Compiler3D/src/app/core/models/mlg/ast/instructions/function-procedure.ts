...
export class FunctionProcedure extends Node {
	...
	constructor(positionToken: PositionToken, type: DataType, toke: string, isFunction: boolean, id: string, listParams: Array<Node>, instructions: Array<Node>) {
    ...
    public isTypeCorrectParam(typeAsig: DataType): boolean{
        const typesCorrect = [DataType.DOUBLE, DataType.INTEGER, DataType.CHAR, DataType.BOOLEAN, DataType.STRING];
        return typesCorrect.includes(typeAsig);
    }

    public addSymbol(handlerComprobation: HandlerComprobation, listTypeParams: Array<DataType>){
    ...
    public override executeComprobationTypeNameAmbitUniqueness(handlerComprobation: HandlerComprobation): any {
        ...
        let listTypeParams: Array<DataType> = new Array<DataType>;

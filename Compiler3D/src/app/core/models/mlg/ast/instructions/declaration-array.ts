...
export class DeclarationArray extends Node{
    ...
    constructor(positionToken: PositionToken, type: DataType, toke: string, isConst: boolean, dataType: DataType, id: string, dimensions: Array<Node>, asignation: DataArray ) {

...
export class AsignationArray extends Node {
	...
	constructor(positionToken: PositionToken, toke: string, isConst: boolean, dataType: DataType, id: string, asignation: DataArray, dimensions: Array<Node>, sizeArray: number, isParama: boolean ) {

...
export class Symbol {
    ...
    private _listParams: Array<DataType>;
	...
	constructor(id: number, nameCode: string, name: string, symbolType: SymbolType, isFunction: boolean , type: DataType, numParams: number , listParams: Array<DataType>, direction: number, size: number, isArray: boolean , listDims: Array<number>, isReference: boolean , encapsulation: string , fullName: string, isConst: boolean ) {
		this._id = id;
    ...
    public get listParams(): Array<DataType> {
        return this._listParams;
    }

    public set listParams(value: Array<DataType>) {

...
export class ConditionalWhile extends Node {
    ...
    public override execute(environment: Environment): any {
        ...
        environment.handlerQuartet.insertQuartet({operator: "comment", arg1: "Generadno el while", arg2: null, result: null});
        ...
        if (this.condition instanceof LogicalOperation) {
            ...
            environment.handlerQuartet.insertQuartet({operator: "comment", arg1: "Instricciones del while", arg2: null, result: null});
            for (let i = 0; i < this.instructions.length; i++) {
